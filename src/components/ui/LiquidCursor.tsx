...
/**
 * LiquidCursor — Theme-aware liquid water-drop cursor with click splash.
 *
 * Behaviour:
 *   • Appears only on [data-liquid-cursor] elements
 *   • On DARK backgrounds → bright cyan glowing drop (reflects light)
 *   • On LIGHT backgrounds → dark shadow drop (inverted, like a dark water bead)
 *   • On CLICK → water drop "splash" ripple that expands and fades
 *   • Organic wobble physics, stretch on movement, specular highlight
 */
